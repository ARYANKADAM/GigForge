...
export const BackgroundRippleEffect = ({
  ...
  return (
    <div
      ...
      style={{
        "--cell-border-color": "#2a2a2a",
        "--cell-fill-color": "#0a0a0a",
        "--cell-shadow-color": "#1a1a1a",
      }}
    >
...
const DivGrid = ({
  ...
  <div
    ...
    className={cn(
      ...
      "hover:opacity-100 hover:bg-neutral-600",
    ...
    style={{
      ...
      transition: "opacity 150ms, background-color 150ms, box-shadow 150ms",
      ...style,
    }}
    onMouseEnter={(e) => {
      e.currentTarget.style.boxShadow = "0px 0px 40px 2px rgba(150,150,150,0.4) inset";
